...
export const PERMISSION_SECTIONS = [
  ...
  },
  {
    ...
    pages: ['PreconStagesAdmin', 'PreconAnalytics'],
    group: null,
  },
  {
    key: 'company_admin',
    ...
    pages: ['CompanyAdmin', 'DataQuality', 'ImportHistoricalData', 'Subtrades', 'KPIDefinitions', 'CompanySettings', 'PreconStagesAdmin', 'PreconAnalytics'],
  },
];
