...
const makeEmpty = (dept = '') => ({ make: '', model: '', year: '', purchase_cost: '', depreciation_method: 'straight_line', useful_life_years: '', salvage_value: '', monthly_insurance_cost: '', monthly_fuel_cost: '', monthly_maintenance_cost: '', department: dept, notes: '' });

export default function VehicleDetailList({ budgetId, items, grossRevenue = 0, defaultDepartment = '' }) {
      ...
      <Card>
        <CardHeader className="flex flex-row items-center justify-between">
          ...
          <div className="flex gap-2">
            ...
            <Button onClick={() => { setForm(makeEmpty(defaultDepartment)); setShowDialog(true); }} size="sm"><Plus className="w-4 h-4 mr-1" /> Add Vehicle</Button>
          </div>
        </CardHeader>
        <CardContent>
          {items.length === 0 ? (
