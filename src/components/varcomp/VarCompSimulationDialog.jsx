      ...
      <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-6">
          ...
          <div className="p-4 bg-slate-50 rounded-lg">
            ...
            <Button className="mt-4 bg-gradient-to-r from-blue-500 to-blue-600 text-white" onClick={runSimulation} disabled={loading}>
                  ...
                  {result.pool_breakdowns?.map((pool, idx) => (
                    <Card key={idx}>
                      <CardContent className="py-4">
                        ...
                        {pool.payouts?.length === 0 && <p className="text-sm text-slate-400">No eligible employees in this pool</p>}
                      </CardContent>
                    </Card>
                  ))}
