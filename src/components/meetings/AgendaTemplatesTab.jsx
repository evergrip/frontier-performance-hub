...
import AgendaSectionBuilder, { SECTION_TYPES, SectionTypeIcon } from './AgendaSectionBuilder';

export default function AgendaTemplatesTab() {
  ...
  return (
    <div className="space-y-4">
      <div className="flex justify-between items-center">
        <p className="text-slate-500 text-sm">Build structured agenda templates with sections, checklists, and fillable fields</p>
