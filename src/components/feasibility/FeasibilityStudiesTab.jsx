...
export default function FeasibilityStudiesTab() {
  ...
  if (isLoading) {
    return <div className="flex justify-center py-12"><div className="animate-spin rounded-full h-8 w-8 border-b-2 border-orange-500" /></div>;
  }
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        ...
        <Button onClick={() => setCreateOpen(true)} className="gap-2 ml-3">
                  ...
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-3 mb-1">
                        <h3 className="text-sm font-semibold text-slate-900 truncate">{study.title}</h3>
                        ...
                        {study.overall_feasibility_rating && (
                          <Badge variant="outline" className="text-xs">
                            {RATING_LABELS[study.overall_feasibility_rating]}
                          </Badge>
                        )}
                      </div>
