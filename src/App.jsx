...
const PreconAnalyticsPage = lazy(() => import('./pages/PreconAnalytics'));
  ...
  return (
    <PageSuspense>
      <Routes>
        ...
        <Route path="/PreconAnalytics" element={<LayoutWrapper currentPageName="PreconAnalytics"><PreconAnalyticsPage /></LayoutWrapper>} />
